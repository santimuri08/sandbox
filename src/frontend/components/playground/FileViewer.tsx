 ...
 *
 * WHERE IT GOES:
 * src/frontend/components/playground/FileViewer.tsx
 */
...
// ============================================================================
// HELPER FUNCTIONS - FILE TREE BUILDING
// ============================================================================
...
// ============================================================================
// HELPER FUNCTIONS - FIND FIRST FILE
// ============================================================================
...
const FileTreeItem = (props: FileTreeItemProps) => {
	...
	const directoryIcon = isExpanded ? '📂' : '📁';
	const icon = node.isDirectory ? directoryIcon : getFileIcon(node.name);
					...
					{selectedFile !== null ? (
						<>
							<header style={{
								...
								{getFileIcon(selectedFileName)} {selectedPath}
							</header>
							<pre
								style={{
									color: '#d4d4d4',
