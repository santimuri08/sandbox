...
const CodeQualityStep = ({ codeQuality, onSelect }: CodeQualityStepProps) => (
	<StepContainer title="Code Quality">
		<nav style={{ display: 'grid', gap: '1rem', gridTemplateColumns: 'repeat(2, 1fr)' }}>
			<OptionCard label="ESLint + Prettier" icon="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/eslint/eslint-original.svg" selected={codeQuality === 'eslint+prettier'} onClick={() => onSelect('eslint+prettier')} />
			<OptionCard label="Biome Linter" icon="https://biomejs.dev/img/favicon.svg" selected={codeQuality === 'biome'} onClick={() => onSelect('biome')} />
		</nav>
	</StepContainer>
);
...
const TailwindStep = ({ useTailwind, onSelect }: TailwindStepProps) => (
	<StepContainer title="Tailwind CSS">
		<nav style={{ display: 'grid', gap: '1rem', gridTemplateColumns: 'repeat(2, 1fr)' }}>
			<OptionCard label="Tailwind CSS" icon="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/tailwindcss/tailwindcss-original.svg" selected={useTailwind} onClick={() => onSelect(true)} />
